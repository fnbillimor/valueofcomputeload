...
CPU_LOOKUP = {
    ...
    "Intel Xeon Platinum 8175 (Skylake)": {
        ...
        "threads_per_package": 48.0,
        "source_type": "benchmark_proxy",
        "source_name": "Closest Skylake Xeon benchmark/reference listings, CPU World",
        "source_note": "Proxy package TDP from common reference sources of 8175M. CPU World",
    },
    "Intel Xeon E5-2686 v4 (Broadwell)": {
        "cpu_tdp_w_package": 145.0,
        "threads_per_package": 36.0,
        "source_type": "benchmark_proxy",
        "source_name": "Broadwell Xeon benchmark reference listings, CPU World",
    ...
    "Intel Xeon Scalable (Icelake)": {
        "cpu_tdp_w_package": 300.0,
        "threads_per_package": 64.0,
        "source_type": "benchmark proxy",
        "source_name": "Intel Xeon Ice Lake 8375C listing. CPU World",
    ...
    "Intel Xeon Scalable (Sapphire Rapids)": {
        ...
        "threads_per_package": 64.0,
        "source_type": "family_proxy - check",
